...
class User(AbstractUser):
    ...
    linkfb = models.CharField(max_length=500, null=True)
    linkin = models.CharField(max_length=500, null=True)
    linktw = models.CharField(max_length=500, null=True)
    linkli = models.CharField(max_length=500, null=True)
